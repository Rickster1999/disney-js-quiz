...
var questionList = [
  {
    quizQuestion:
      "Question #1: In which movie does a princess dance with the villain?",
  ...
  {
    quizQuestion:
      "Question #5: What is the most expensive movie in disney history?",
    options: [
  ...
  {
    quizQuestion:
      "Question #7: Which musical artist/band did lilo copy the most?",
    options: ["Johnny Cash", "The Beatles", "Jackson 5", "Elvis Presley"],
    correctAnswer: 3,
  },
  {
    quizQuestion:
      "Question #8: How many land's are inside the Disneyland park?",
    options: ["8", "9", "4", "6"],
    correctAnswer: 1,
  },
  {
...
function getCurrentQuestion() {
  // you can just shorthand this return questionList[iter];
...
function quiz() {
  // This is an unecssary call since you can access both the question list and iter from within the function.
  // Just do var currentQuestion = questionList[iter];
  var currentQuestion = getCurrentQuestion();
  questionEntry.textContent = currentQuestion.quizQuestion;
  // Remove logs when you're done. They look bad, clog up the logs, and in a professional site can be a security risk
...
//I would put the scoreCounter higher up it doesn't really make sense down here
scoreCounter.textContent = "Score: " + score;
var timeLeft = 60;
function countdown() {
...
function endScreen() {
  // quizSection doesn't exist
  var quizSection = document.getElementById("quizSection");
  enterName.setAttribute("style", "display: null");
  //This isn't doing anything because your element variable for this is just timer above
